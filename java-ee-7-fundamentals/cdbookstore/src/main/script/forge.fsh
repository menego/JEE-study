...
project-new --named application-cdbookstore --topLevelPackage org.application.cdbookstore --finalName applicationCDBookStore ;
...
jpa-new-field --named country --type Country --relationshipType Many-to-One ;
# Constraints
...
jpa-new-field --named creditCardType --type CreditCardType --columnName credit_card_type ;
...
jpa-new-field --named role --type UserRole --columnName user_role ;
...
jpa-new-field --named preferredLanguage --type Language --columnName preferred_language ;
...
jpa-new-field --named language --type Language ;
# Relationships
# TODO FORGE-2464
jpa-new-field --named category --type Category --relationshipType Many-to-One ;
jpa-new-field --named authors --type Author --relationshipType One-to-Many ;
jpa-new-field --named publisher --type Publisher --relationshipType Many-to-One ;
# Constraints
...
# TODO FORGE-2464
jpa-new-field --named label --type Label --relationshipType Many-to-One ;
jpa-new-field --named musicians --type Musician --relationshipType Many-to-Many ;
jpa-new-field --named genre --type Genre --relationshipType Many-to-One ;


#  Musician Entity
#  ############
cd ../Musician.java ;
jpa-new-field --named cds --type CD --relationshipType Many-to-Many ;
...
# Relationships
jpa-new-field --named item --type Item --relationshipType Many-to-One --cascadeType PERSIST ;
# Constraints
...
# Relationships
# TODO FORGE-2466
jpa-new-field --named customer --type User --relationshipType Many-to-One ;
jpa-new-field --named orderLines --type org.application.cdbookstore.model.OrderLine --relationshipType One-to-Many ;
# Constraints
...
#  ############
# TODO FORGE-2464
java-new-package --named org.application.cdbookstore.model --createPackageInfo ;
...
cdi-new-interceptor --named LoggingInterceptor --interceptorBinding Loggable --targetPackage ~.util ;
...
cdi-new-interceptor --named CatchExceptionInterceptor --interceptorBinding CatchException  --targetPackage ~.view.util ;
cdi-add-injection-point --named logger --type java.util.logging.Logger ;
...
#  ############
# TODO FORGE-2466
cdi-new-bean --named IsbnGenerator --qualifier ThirteenDigits --targetPackage ~.util ;
cdi-add-injection-point --named logger --type java.util.logging.Logger ;
# TODO FORGE-2466
cdi-add-injection-point --named prefix --type String --qualifiers ThirteenDigits ;
cdi-add-injection-point --named postfix --type int --qualifiers ThirteenDigits ;
# TODO Implement interface
java-new-method --methodName generateNumber --returnType String --accessType public ;

#  IssnGenerator
#  ############
cdi-new-bean --named IssnGenerator --qualifier EightDigits --targetPackage ~.util ;
cdi-add-injection-point --named logger --type java.util.logging.Logger ;
# TODO FORGE-2466
cdi-add-injection-point --named prefix --type String --qualifiers EightDigits ;
cdi-add-injection-point --named postfix --type int --qualifiers EightDigits ;
# TODO Implement interface
java-new-method --methodName generateNumber --returnType String --accessType public ;
...
#  Number producer
#  ############
java-new-class --named NumberProducer --targetPackage org.application.cdbookstore.util ;
# TODO producers
...
java-add-annotation --annotation ThirteenDigits --onProperty prefix1 ;
...
java-add-annotation --annotation ThirteenDigits --onProperty postfix1 ;
...
java-add-annotation --annotation EightDigits --onProperty prefix2 ;
...
java-add-annotation --annotation EightDigits --onProperty postfix2 ;
...
java-add-annotation --annotation ThirteenDigits --onProperty prefix3 ;
java-add-annotation --annotation EightDigits --onProperty prefix3 ;
...
java-add-annotation --annotation ThirteenDigits --onProperty postfix3 ;
java-add-annotation --annotation EightDigits --onProperty postfix3 ;
...
java-add-annotation --annotation org.application.cdbookstore.util.Vat --onProperty vatRate ;
...
java-add-annotation --annotation org.application.cdbookstore.util.Discount --onProperty discountRate ;
...
# TODO ~ 
scaffold-generate --provider Faces --webRoot /admin --targets org.application.cdbookstore.model.* ;
...
# TODO ~
rest-generate-endpoints-from-entities --contentType application/xml application/json --targets CD ;
rest-generate-endpoints-from-entities --contentType application/xml application/json --targets Book ;
...
# TODO ~
arquillian-create-test --enableJPA --targets org.application.cdbookstore.view.* ;
...
# TODO ~
arquillian-create-test --enableJPA --targets org.application.cdbookstore.rest.* ;
